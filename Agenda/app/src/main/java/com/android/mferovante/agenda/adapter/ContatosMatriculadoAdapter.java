...
public class ContatosMatriculadoAdapter extends RecyclerView.Adapter<ContatosMatriculadoAdapter.MyViewHolder> {
    private List<Contato> contatosList;


    public ContatosMatriculadoAdapter(List<Contato> contatosList) {
        this.contatosList = contatosList;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.contato_matriculado_list_row, parent, false);
